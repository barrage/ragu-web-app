export default {
  ...
  agents: {
    ...
    labels: {
      ...
      presencePenalty: 'Prevención de repetición',
      maxCompletionTokens: 'Limitar la longitud de la respuesta del agente',
      configuration_max_completion_tokens: 'Longitud de la respuesta',
    },
      ...
      what_can_you_do_here: {
        ...
        items: {
          labels: {
            ...
            wap: 'Activar o un agente de WhatsApp',
          },
          descriptions: {
            ...
            activate_wap_agent: 'Activa o desactiva un agente de WhatsApp',
          },
        },
      },
      how_to_manage: {
  ...
  collections: {
    ...
    search: {
      ...
      no_results_description: 'Intenta ajustar tu consulta de búsqueda o prueba con palabras clave diferentes',
  ...
  global_settings: {
    title: 'Configuraciones',
    description: 'Administre sus configuraciones y elija las opciones que mejor se adapten a sus necesidades',
    chats_config: {
      title: 'Configuración del chat',
    },
    info: {
      title: 'Configuración del documento',
      description: 'Resumen de la configuración del documento y proveedores disponibles',
      chunkers: {
        title: 'Fragmentadores predeterminados',
      },
      document_providers: {
      ...
      document_types: {
        title: 'Tipos de archivos compatibles',
      },
      vector_providers: {
    ...
    titles: {
      ...
      chat_max_history_tokens: 'Máximo de tokens del historial del chat',
      agent_presence_penalty: 'Prevención de repetición del agente',
      agent_title_max_completion_tokens: 'Máximo de tokens para el título del agente',
      agent_summary_max_completion_tokens: 'Máximo de tokens para el resumen del agente',
      whatsapp_agent_max_completion_tokens: 'Máximo de tokens para respuestas en WhatsApp',
    },
    descriptions: {
      settings_description: 'Configurar ajustes y parámetros globales del chat',
      chat_max_history_tokens: 'Número máximo de tokens a mantener en el historial del chat',
      agent_presence_penalty: 'Valor de penalización para información repetida en respuestas',
      agent_title_max_completion_tokens: 'Máximo de tokens para generar títulos de chat',
      agent_summary_max_completion_tokens: 'Máximo de tokens para generar resúmenes de chat',
      whatsapp_agent_max_completion_tokens: 'Máximo de tokens para respuestas en WhatsApp',
    },
    labels: {
      chatMaxHistoryTokens: 'Tokens de historial del chat',
      agentPresencePenalty: 'Prevención de repetición',
      agentTitleMaxCompletionTokens: 'Tokens de generación de títulos',
      agentSummaryMaxCompletionTokens: 'Tokens de generación de resúmenes',
      whatsappAgentMaxCompletionTokens: 'Tokens de respuesta en WhatsApp',
    },
    rules: {
      required: 'Este campo es obligatorio',
    },
    ...
    update_success_description: 'Sus configuraciones han sido actualizadas correctamente.',
    update_error_title: 'Error en la actualización',
    update_error_description: 'Se produjo un error al actualizar sus configuraciones. Por favor, inténtelo de nuevo.',
  },
  common: {
  ...
  global_disclaimer: 'Asistente impulsado por IA aquí. Compruebe información importante.',
