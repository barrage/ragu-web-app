...
export class RaguWebSocket {
  ...
  /**
   * Send a text message without any attachments.
   */
  ...
  /**
   * Sends a message of type `workflow.existing`.
   */
  ...
  /**
   * Sends a message of type `workflow.new`.
   */
  ...
  /**
   * Sends a message of type `workflow.close`.
   */
  closeWorkflow() {
    const message = {
      type: "workflow.close",
  ...
  /**
   * Sends a message of type `workflow.cancel_stream`.
   */
  cancelStream() {
    this.send({
