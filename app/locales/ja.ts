export default {
  ...
  whatsapp_agents: {
    ...
    set_as_active: {
      ...
      dialog_title: 'WhatsAppエージェントをアクティブにする',
      dialog_description: 'このWhatsAppエージェントをアクティブに設定してもよろしいですか？これにより、このエージェントがWhatsApp会話を処理する責任を負います。',
    },
    deactivate: {
      dialog_title: 'WhatsAppエージェントを非アクティブにする',
      description: 'このWhatsAppエージェントを非アクティブにしてもよろしいですか？これにより、このエージェントがWhatsApp会話を処理する責任を負いません。',
      action: '非アクティブにする',
      success_notification_title: 'WhatsAppエージェントが非アクティブになりました',
      success_notification_message: 'WhatsAppエージェントが正常に非アクティブになりました。',
      success_description: 'エージェントが正常に非アクティブになりました。',
      ...
      what_can_you_do_here: {
        ...
        items: {
          ...
          descriptions: {
            ...
            activate_wap_agent: 'WhatsAppエージェントをアクティブ化または非アクティブ化します',
          },
        },
      },
      how_to_manage: {
  ...
  collections: {
    ...
    search: {
      ...
      no_results_description: '検索クエリを調整するか、別のキーワードで試してみてください',
