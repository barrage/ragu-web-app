export default {
      ...
      what_can_you_do_here: {
        ...
        items: {
          labels: {
            ...
            wap: 'Ativar um agente do WhatsApp',
          },
          descriptions: {
            ...
            activate_wap_agent: 'Ativar ou desativar um agente do WhatsApp',
          },
        },
      },
      how_to_manage: {
  ...
  collections: {
    ...
    search: {
      ...
      no_results_description: 'Tente ajustar sua consulta de pesquisa ou usar palavras-chave diferentes',
      query_placeholder: 'Digite sua consulta...',
      query_label: 'Pesquisar',
      limit_label: 'Limite de resultados',
      max_distance_label: 'Distância máxima',
  ...
  global_settings: {
    ...
    info: {
      ...
      description: 'Visão geral das configurações do documento e dos provedores disponíveis',
      chunkers: {
        title: 'Divisores Padrão',
      },
      document_providers: {
        title: 'Provedores de Documentos',
      },
      embedding_providers: {
        title: 'Provedores de Incorporação',
      },
      document_types: {
    ...
    titles: {
      ...
      chat_max_history_tokens: 'Máximo de Tokens de Histórico do Chat',
      agent_presence_penalty: 'Prevenção de Repetição do Agente',
      agent_title_max_completion_tokens: 'Máximo de Tokens para o Título do Agente',
      agent_summary_max_completion_tokens: 'Máximo de Tokens para o Resumo do Agente',
      whatsapp_agent_max_completion_tokens: 'Máximo de Tokens para Respostas no WhatsApp',
    },
    descriptions: {
      settings_description: 'Configurar as configurações globais do chat e parâmetros',
      chat_max_history_tokens: 'Número máximo de tokens a serem mantidos no histórico do chat',
      agent_presence_penalty: 'Valor de penalização para informações repetidas nas respostas',
      agent_title_max_completion_tokens: 'Número máximo de tokens para gerar títulos do chat',
      agent_summary_max_completion_tokens: 'Número máximo de tokens para gerar resumos do chat',
      whatsapp_agent_max_completion_tokens: 'Número máximo de tokens para respostas no WhatsApp',
    },
    labels: {
      chatMaxHistoryTokens: 'Tokens de Histórico do Chat',
      agentPresencePenalty: 'Prevenção de Repetição',
      agentTitleMaxCompletionTokens: 'Tokens para Geração de Título',
      agentSummaryMaxCompletionTokens: 'Tokens para Geração de Resumo',
      whatsappAgentMaxCompletionTokens: 'Tokens de Resposta no WhatsApp',
    },
    rules: {
      required: 'Este campo é obrigatório',
    },
