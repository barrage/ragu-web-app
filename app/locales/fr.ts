export default {
  ...
  placeholders: {
    ...
    choose_agent: 'Choisissez un agent',
    choose_agent_status: 'Choisissez le statut de l\'agent',
  ...
  agents: {
    ...
    labels: {
      ...
      errro_message: 'Instruction de Message d\'Erreur',
      version: 'Version',
      evaluation: 'Évaluation',
      feedback: 'Commentaires',
      message: 'Message',
      errorMessage: 'Message d\'erreur personnalisé',
      presencePenalty: 'Prévention de la répétition',
      maxCompletionTokens: 'Limitez la longueur de la réponse de l\'agent',
      configuration_max_completion_tokens: 'Longueur de la réponse',
    },
    buttons: {
    ...
    placeholder: {
      ...
      errorInstruction: 'Entrer un message d\'erreur personnalisé...',
      ...
      what_can_you_do_here: {
        ...
        items: {
          ...
          descriptions: {
            ...
            activate_wap_agent: 'Activer ou désactiver un agent WhatsApp',
          },
        },
      },
      how_to_manage: {
  ...
  collections: {
    ...
    search: {
      ...
      no_results_description: 'Essayez d\'ajuster votre requête de recherche ou essayez d\'utiliser d\'autres mots-clés',
  ...
  users: {
    ...
    titles: {
      ...
      multiple_users_csv: 'Plusieurs utilisateurs',
      invite_users_options: 'Options d\'invitation des utilisateurs',
    },
    descriptions: {
      invite_users: 'Choisissez l\'option qui vous convient le mieux et simplifiez le processus d\'invitation des utilisateurs.',
      invite_single_user: 'Invitez un nouvel utilisateur en quelques étapes seulement.',
      invite_multiple_users_csv: 'Ajoutez rapidement plusieurs utilisateurs à la fois via un fichier CSV.',
    },
    delete_user: {
