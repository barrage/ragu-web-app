...
export default {
  ...
  whatsapp_agents: {
    ...
    set_as_active: {
      label: 'Postavi kao aktivni',
      success_notification_title: 'WhatsApp agent je postavljen kao aktivni',
      success_notification_message: 'Aktivni WhatsApp agent je uspješno promijenjen.',
      already_active_message: 'Ovaj agent je već aktivni',
    ...
    deactivate: {
      dialog_title: 'Deaktiviraj WhatsApp agenta',
      description: 'Jeste li sigurni da želite deaktivirati ovog WhatsApp agenta? To će sprestati agenta da ne rukuje s WhatsApp razgovorima.',
      action: 'Deaktiviraj',
      success_notification_title: 'WhatsApp agent je deaktiviran',
      success_notification_message: 'WhatsApp agent je uspješno deaktiviran.',
  ...
  agents: {
    ...
    labels: {
      ...
      errro_message: 'Uputa za poruku o pogrešci',
      version: 'Verzija',
    ...
    placeholder: {
      ...
      errorInstruction: 'Unesite prilagođenu poruku o pogrešci...',
      ...
      what_can_you_do_here: {
        ...
        items: {
          labels: {
            ...
            wap: 'Aktivirajte WhatsApp agenta',
          },
          descriptions: {
            ...
            activate_wap_agent: 'Aktivirajte ili deaktivirajte WhatsApp agenta',
          },
        },
      },
      how_to_manage: {
  ...
  collections: {
    ...
    search: {
      ...
      no_results_description: 'Pokušajte prilagoditi vaš upit za pretraživanje ili pokušajte s drugim ključnim riječima',
