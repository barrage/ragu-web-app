...
export default {
  ...
  users: {
    ...
    import: {
      ...
      failed: 'Neuspješno',
      line: 'Redak',
      line_description: 'Neuspješno na retku',
      reason: 'Razlog',
      reason_description: 'Nevaljani podaci',
      error_message: 'Poruka o pogrešci',
      new_user: 'Novi Korisnik',
      already_exists: 'Već Postoji',
      title: 'Uvezi Korisnike iz CSV',
      notes_title: 'Važne Napomene',
      note_file_format: 'Provjerite je li vaša datoteka u .csv formatu. Ostali vrste datoteka neće raditi.',
      note_headers: 'Vaša datoteka mora sadržavati točne oznake: FirstName, LastName, FullName, Email, Role.',
      note_data_types: 'Vrste podataka - Polja imena: Moraju biti tekst (samo slova), E-mail: Koristite valjani format e-maila, Role:',
      note_file_size: 'Ograničenje veličine datoteke: Maksimalna veličina datoteke je 5MB.',
      note_download_template: 'Preuzmite predložak u nastavku kako biste bili sigurni da je vaša datoteka ispravno formatirana.',
      download_template: 'Preuzmi CSV Predložak',
      drop_file: 'Ispustite CSV datoteku ovdje ili',
      click_to_upload: 'kliknite za prijenos',
      description: 'Lako dodajte više korisnika odjednom premačući CSV datoteku. Slijedite upute kako biste bili sigurni da je vaša datoteka ispravno formatirana i da ispunjava zahtjeve.',
      success_empty_state: {
        title: 'Nema Uvezenih Korisnika',
        description: 'Korisnici nisu uspješno uvezeni.',
      },
      failed_empty_state: {
        title: 'Nema Neuspješno Uvezenih Korisnika',
        description: 'Sve je uspješno uvezeno.',
      },
      errors: {
        validation: {
          FullName: 'Pogrešan format punog imena',
          Email: 'Nevaljana adresa e-maila',
          Role: 'Nevaljana rola',
          default: 'Nevaljani {field}',
        },
        missing_fields: 'Neki polja nedostaju',
    ...
    notifications: {
      ...
      import: {
        error_file_type_title: 'Neispravan tip datoteke',
        error_file_type_description: 'Molimo prenesite CSV datoteku.',
        error_file_size_title: 'Datoteka je prevelika',
        error_file_size_description: 'Veličina datoteke ne smije premašiti 5MB.',
        error_title: 'Neuspješno Uvozivanje',
